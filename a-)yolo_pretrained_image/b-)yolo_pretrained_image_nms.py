#Bu dosyada kodumuza non maximum suppression işlemi uygulayazağz
...
for max_id in max_ids: #burada bu max doğruluk değerlerine sahip box değerlerine teker tekerk ulaştık for döngüsü sayesinde
    ...
    box = boxes_list[max_class_id] #max güvenilirliğe sahip boxları boxes_list  listesinden çektik ve box değişkenine atadık
